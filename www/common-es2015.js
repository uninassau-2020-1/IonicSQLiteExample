...
let ContactService = class ContactService {
    ...
    getById(id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const data = [id];
            const result = yield this.db.executeSQL(sql, data);
            const rows = result.rows;
            const contact = new _contact__WEBPACK_IMPORTED_MODULE_1__["Contact"]();
    ...
    getAll() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const result = yield this.db.executeSQL(sql);
