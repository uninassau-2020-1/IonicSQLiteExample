...
var map = {
	"./contacts/contact-form/contact-form.module": [
		"./src/app/contacts/contact-form/contact-form.module.ts",
		"common",
		"contacts-contact-form-contact-form-module"
	],
	"./contacts/contact-list/contact-list.module": [
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _core_service_database_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./core/service/database.service */ "./src/app/core/service/database.service.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, db) {
    ...
    AppComponent.ctorParameters = function () { return [
        ...
        { type: _core_service_database_service__WEBPACK_IMPORTED_MODULE_1__["DatabaseService"] }
    ]; };
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"],
            ...
            _core_service_database_service__WEBPACK_IMPORTED_MODULE_1__["DatabaseService"]])
    ], AppComponent);
    return AppComponent;
}());
...
/***/ "./src/app/core/service/database.service.ts":
/*!**************************************************!*\
  !*** ./src/app/core/service/database.service.ts ***!
  \**************************************************/
...
var DatabaseService = /** @class */ (function () {
    function DatabaseService(sqlite, sqlitePorter) {
        this.sqlite = sqlite;
        this.sqlitePorter = sqlitePorter;
        this.databaseName = 'contatos.db';
    }
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        _a = this;
                        return [4 /*yield*/, this.sqlite.create({ name: this.databaseName, location: 'default' })];
                    case 1:
                        _a.db = _b.sent();
                    ...
                    case 3:
                        error_1 = _b.sent();
                        console.error('Ocorreu um erro ao criar o banco de dados', error_1);
                        return [3 /*break*/, 4];
    ...
    DatabaseService.prototype.createDatabase = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var sqlCreateDatabase, result;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        sqlCreateDatabase = this.getCreateTable();
                        return [4 /*yield*/, this.sqlitePorter.importSqlToDb(this.db, sqlCreateDatabase)];
                    case 1:
                        result = _a.sent();
    ...
    DatabaseService.prototype.getCreateTable = function () {
        var sqls = [];
        sqls.push('CREATE TABLE IF NOT EXISTS contacts (id integer primary key AUTOINCREMENT, name varchar(100));');
        return sqls.join('\n');
    };
    DatabaseService.prototype.executeSQL = function (sql, params) {
    ...
    DatabaseService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_native_sqlite_ngx__WEBPACK_IMPORTED_MODULE_2__["SQLite"], _ionic_native_sqlite_porter_ngx__WEBPACK_IMPORTED_MODULE_3__["SQLitePorter"]])
    ], DatabaseService);
